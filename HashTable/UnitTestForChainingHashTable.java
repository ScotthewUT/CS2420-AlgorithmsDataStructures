...
/**
 * Provides unit tests for the ChainingHashTable class.
 * 
 * @author Bridger Peterson (u0971665) & Scott Crowley (u1178178)
 * @version 12 November 2018
 */
class UnitTestForChainingHashTable {
	
	static ChainingHashTable hashTable;
	...
	@Test
	void testAdd() {
		hashTable = new ChainingHashTable(10, okFxn);
	...
	@Test
	void testAddAll() {
		hashTable = new ChainingHashTable(10, goodFxn);
	...
	@Test
	void testContains() {
		hashTable = new ChainingHashTable(10, badFxn);
		hashTable.add("cat");
