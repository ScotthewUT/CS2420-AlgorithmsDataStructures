...
/**
 * Class representation of a generic library book that inherits from Book.
...
public class LibraryBookGeneric<Type> extends Book {
	 ...
	 */
	public boolean checkOut(Type _holder, int month, int day, int year) {
